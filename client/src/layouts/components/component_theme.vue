<template>
  <div class="p-1">
    <label class="toggle text-base-content">
      ...
      <svg aria-label="enabled" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg aria-label="disabled" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
          <path
          ...
          <path d="M12 20V22" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
          <path d="M4 12L2 12" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
          <path d="M22 12L20 12" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
          <path d="M19.7778 4.22266L17.5558 6.25424" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
          <path d="M4.22217 4.22266L6.44418 6.25424" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
          <path d="M6.44434 17.5557L4.22211 19.7779" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
          <path d="M19.7778 19.7773L17.5558 17.5551" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
        </g>
      </svg>
...
const theme = ref<boolean>(main.theme === 'light')
...
const changeTheme = () => {
  main.change_theme({ newTheme: main.theme === 'dark' ? 'light' : 'dark' })
  theme.value = main.theme === 'light'
}
</script>