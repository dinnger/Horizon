...
interface IProperties extends INodeClassProperty {
	dialect: Extract<INodeClassPropertyType, { type: 'options' }>
	...
	query: Extract<INodeClassPropertyType, { type: 'code' }>
	replacements: Extract<INodeClassPropertyType, { type: 'code' }>
}

interface ICredentials extends INodeClassProperty {
	database: Extract<INodeClassPropertyType, { type: 'options' }>
	config: Extract<INodeClassPropertyType, { type: 'code' }>
}
