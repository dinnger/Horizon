...
interface IProperties extends INodeClassProperty {
	...
	authSecret: Extract<INodeClassPropertyType, { type: 'credential' }>
	query: Extract<INodeClassPropertyType, { type: 'string' }>
	limit: Extract<INodeClassPropertyType, { type: 'string' }>
	offset: Extract<INodeClassPropertyType, { type: 'string' }>
	volume: Extract<INodeClassPropertyType, { type: 'number' }>
	parameters: Extract<INodeClassPropertyType, { type: 'code' }>
}
