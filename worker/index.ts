...
import type { IWorkflow } from './modules/workflow/index.js'
...
import { ServerCommunication } from './modules/communication/serverCommunication.js'
...
const { workflowId, port } = workerData || getArgs()
const WORKER_ID = workerData?.workerId || process.env.WORKER_ID || uuidv4()
const SERVER_PORT = workerData?.serverPort || process.env.SERVER_PORT || '3000'
